...
import com.gavin.rxbus.annotation.accept.Accept;
import com.gavin.rxbus.annotation.accept.AcceptScheduler;
import com.gavin.rxbus.annotation.accept.AcceptType;
import com.gavin.rxbus.annotation.accept.DefaultAcceptConfiguration;
import com.gavin.rxbus.util.ABTextUtil;
...
public class RxBusAnnotationManager {
    ...
    protected static final String TAG = "RxBusAnnotationManager";
    ...
    private <T> void registerObservable(final Method method, final String tag, Class<T> clazz, AcceptScheduler acceptScheduler) {
        ...
        Observable<T> observable = RxBus.getInstance().register(tag, clazz);
        ...
        switch (acceptScheduler) {
            ...
            case HANDLER:
                ...
                schedulerObservable = observable.observeOn(AndroidSchedulers.from(handler.getLooper()));
                break;
